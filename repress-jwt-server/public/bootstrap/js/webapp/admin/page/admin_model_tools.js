...
define(function(require,exports) {
    ...
    var urls = {};
    urls.get_connetion_list = '/admin/model/connection-list';
    urls.get_db_tables = '/admin/model/db-tables';
    urls.gen_models = '/admin/model/gen-models';
        ...
        $("#system_model_tools_list_grid").jqGrid({
            ...
            loadBeforeSend: function(request) {
                ...
                if(user && JSON.parse(user)['token']) {
                    request.setRequestHeader("Authorization", JSON.parse(user)['token']);
                }
            },
            ajaxGridOptions: {
